...
if(NOT ${found})
  ...
  if(WIN32 AND NOT ${executable})
    ...
    foreach(_CURRENT_VERSION ${Python_ADDITIONAL_VERSIONS} "${preferred_version}" "${min_version}")
      find_exthost_program(PYTHON_EXECUTABLE
  ...
  find_exthost_package(PythonInterp "${preferred_version}")
  if(NOT PYTHONINTERP_FOUND)
    find_exthost_package(PythonInterp "${min_version}")
  endif()
  ...
  if(_found)
    ...
    if(NOT ANDROID AND NOT OSX_FRAMEWORK)
